...
def test_engine_integration_sync(clean_storage):
    ...
    engine_alice = StrataEngine(
        storage_path=storage_alice, gossip_port=10001, p2p_port=10002
    )
    ...
    engine_bob = StrataEngine(
        storage_path=storage_bob, gossip_port=10003, p2p_port=10004
    )
